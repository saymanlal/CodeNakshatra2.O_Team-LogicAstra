...
| **Phase 18** | **Pipelined Concurrency** | Implemented parallel transaction scheduling, P2P socket leak protection, and concurrency UI. |
...
### Phase 18: Pipelined Concurrency
...
* **Socket Safety**: Patched P2P WebSocket cleanups to close connections on removal, preventing file descriptor leaks and out-of-sync block heights.
